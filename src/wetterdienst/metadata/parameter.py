...
class Parameter(Enum):
    ...
    # ---- intensity ----
    # irradiance (power per area) rather than irradiation (energy per area) over the interval;
    # a source reports one or the other and they are not convertible without the interval
    RADIATION_GLOBAL_INTENSITY = "RADIATION_GLOBAL_INTENSITY"
    RADIATION_SKY_LONG_WAVE_INTENSITY = "RADIATION_SKY_LONG_WAVE_INTENSITY"
    RADIATION_SKY_SHORT_WAVE_DIFFUSE_INTENSITY = "RADIATION_SKY_SHORT_WAVE_DIFFUSE_INTENSITY"
    # ---- probability ----
