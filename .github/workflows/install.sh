...
if [ "${flavor}" = "testing" ]; then
  uv sync --active --extra bufr --extra export --extra influxdb --extra interpolation --extra pdf --extra plotting --extra radar --extra radarplus --extra restapi --extra sql
