...
class NoaaIsdParameter(DatasetTreeCore):
    ...
    class HOURLY(Enum):
        ...
        # TODO: cloud cover total is usually measured on a HOURLY basis ending at midnight
        #  so this is a synonym for midnight-to-midnight

        # Average HOURLY wind speed (meters per second or miles per hour as per user preference)
        WIND_SPEED = "awnd"  # m/s
        ...
        # HOURLY minimum temperature of water in an evaporation pan (Fahrenheit or Celsius as per user preference)
        TEMPERATURE_WATER_EVAPORATION_PAN_MIN = "mnpn"
        # HOURLY maximum temperature of water in an evaporation pan  (Fahrenheit or Celsius as per user preference)
        TEMPERATURE_WATER_EVAPORATION_PAN_MAX = "mxpn"
        # Peak gust time (hours and minutes, i.e., HHMM)
        TIME_WIND_GUST_MAX = "pgtm"
        # HOURLY percent of possible sunshine (percent)
        ...
        # 24-hour wind movement (km or miles as per user preference, miles on HOURLY Form pdf file)
...
PARAMETER_MULTIPLICATION_FACTORS = {
    NoaaIsdParameter.HOURLY.PRECIPITATION_HEIGHT.value: 1 / 10,
    NoaaIsdParameter.HOURLY.PRECIPITATION_HEIGHT_MULTIDAY.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_MAX_200.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_MAX_200_MULTIDAY.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_MIN_200.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_MIN_200_MULTIDAY.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_MEAN_200.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_SPEED.value: 1 / 10,
    NoaaIsdParameter.HOURLY.EVAPORATION_HEIGHT.value: 1 / 10,
    NoaaIsdParameter.HOURLY.EVAPORATION_HEIGHT_MULTIDAY.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_WATER_EVAPORATION_PAN_MAX.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_WATER_EVAPORATION_PAN_MIN.value: 1 / 10,
    # Height definition similar to temperature with three digits
    # 0 - unknown
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_UNKNOWN_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_UNKNOWN_180.value: 1 / 10,
    # 1 - grass
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_180.value: 1 / 10,
    # 2 - fallow
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_FALLOW_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_FALLOW_180.value: 1 / 10,
    # 3 - bare ground
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_GROUND_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_GROUND_180.value: 1 / 10,
    # 4 - brome grass
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_005: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_010: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_020: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_050: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_100: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_150: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BROME_GRASS_180: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_005: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_010: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_020: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_050: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_100: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_150: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BROME_GRASS_180: 1 / 10,
    # 5 - sod
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_SOD_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_SOD_180.value: 1 / 10,
    # 6 - straw mulch
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_STRAW_MULCH_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_STRAW_MULCH_180.value: 1 / 10,
    # 7 - grass muck
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_GRASS_MUCK_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_GRASS_MUCK_180.value: 1 / 10,
    # 8 - bare muck
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MIN_BARE_MUCK_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_005.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_010.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_020.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_050.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_100.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_150.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_SOIL_MAX_BARE_MUCK_180.value: 1 / 10,
    NoaaIsdParameter.HOURLY.ICE_ON_WATER_THICKNESS.value: 1 / 10,
    NoaaIsdParameter.HOURLY.TEMPERATURE_AIR_200.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WATER_EQUIVALENT_SNOW_DEPTH.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WATER_EQUIVALENT_SNOW_DEPTH_NEW.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX_5SEC.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX_1MIN.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX_2MIN.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX_INSTANT.value: 1 / 10,
    NoaaIsdParameter.HOURLY.WIND_GUST_MAX_1MILE.value: 1 / 10,
}
