...
class GeosphereObservationParameter(DatasetTreeCore):
    class MINUTE_10(DatasetTreeCore):
        class MINUTE_10(Enum):
            ...
            TEMPERATURE_AIR_MIN_200 = "tsmax"  # Lufttemperaturminimum in 2m °C
            TEMPERATURE_SOIL_MEAN_010 = "tb10"  # Erdbodentemperatur in 10cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_020 = "tb20"  # Erdbodentemperatur in 20cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_050 = "tb50"  # Erdbodentemperatur in 50cm Tiefe °C
        ...
        WIND_SPEED_MAX_TIME = MINUTE_10.WIND_SPEED_MAX_TIME
    ...
    class HOURLY(DatasetTreeCore):
        class HOURLY(Enum):
            ...
            TEMPERATURE_AIR_MEAN_200 = "tl"  # Lufttemperatur 2 meter °C
            TEMPERATURE_AIR_MIN_005 = "tsmin"  # Lufttemperatur 5cm Minimalwert °C
            TEMPERATURE_SOIL_MEAN_010 = "tb10"  # Erdbodentemperatur in 10 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_020 = "tb20"  # Erdbodentemperatur in 20 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_050 = "tb50"  # Erdbodentemperatur in 50 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_100 = "tb100"  # Erdbodentemperatur in 100 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_200 = "tb200"  # Erdbodentemperatur in 200 cm Tiefe °C
        ...
        TEMPERATURE_AIR_MIN_005 = HOURLY.TEMPERATURE_AIR_MIN_005
    ...
    class DAILY(DatasetTreeCore):
        class DAILY(Enum):
            ...
            TEMPERATURE_AIR_MAX_200 = "tlmax"  # Lufttemperatur 2m Maximum °C
    ...
    class MONTHLY(DatasetTreeCore):
        class MONTHLY(Enum):
            ...
            TEMPERATURE_SOIL_MAX_100 = "tb100_max"  # Erdbodentemperatur -100cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_200 = "tb200_max"  # Erdbodentemperatur -200cm Monatsmaximum °C
            TEMPERATURE_SOIL_MEAN_010 = "tb10_mittel"  # Erdbodentemperatur -10cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_020 = "tb20_mittel"  # Erdbodentemperatur -20cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_050 = "tb50_mittel"  # Erdbodentemperatur -50cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_100 = "tb100_mittel"  # Erdbodentemperatur -100cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_200 = "tb200_mittel"  # Erdbodentemperatur -200cm Monatsmittel °C
            TEMPERATURE_SOIL_MIN_010 = "tb10_min"  # Erdbodentemperatur -10cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_020 = "tb20_min"  # Erdbodentemperatur -20cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_050 = "tb50_min"  # Erdbodentemperatur -50cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_100 = "tb100_min"  # Erdbodentemperatur -100cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_200 = "tb200_min"  # Erdbodentemperatur -200cm Monatsminimum °C
