...
class GeosphereObservationParameter(DatasetTreeCore):
    class MINUTE_10(DatasetTreeCore):
        class MINUTE_10(Enum):
            ...
            TEMPERATURE_AIR_MAX_0_05 = "tsmax"  # Lufttemperaturmaximum in 5cm °C
            TEMPERATURE_AIR_MAX_2 = "tlmax"  # Lufttemperaturmaximum in 2m °C
            TEMPERATURE_AIR_MEAN_0_05 = "ts"  # Lufttemperatur in 5cm °C
            TEMPERATURE_AIR_MEAN_2 = "tl"  # Lufttemperatur in 2m °C
            TEMPERATURE_AIR_MIN_0_05 = "tsmin"  # Lufttemperaturminimum in 5cm °C
            TEMPERATURE_AIR_MIN_2 = "tsmax"  # Lufttemperaturminimum in 2m °C
            TEMPERATURE_SOIL_MEAN_0_1 = "tb10"  # Erdbodentemperatur in 10cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_2 = "tb20"  # Erdbodentemperatur in 20cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_5 = "tb50"  # Erdbodentemperatur in 50cm Tiefe °C
            ...
            WIND_SPEED_MEAN_10 = "ffam"  # vektorielle Windgeschwindigkeit in 10m Höhe m/s
        ...
        TEMPERATURE_AIR_MAX_0_05 = MINUTE_10.TEMPERATURE_AIR_MAX_0_05
        TEMPERATURE_AIR_MAX_2 = MINUTE_10.TEMPERATURE_AIR_MAX_2
        TEMPERATURE_AIR_MEAN_0_05 = MINUTE_10.TEMPERATURE_AIR_MEAN_0_05
        TEMPERATURE_AIR_MEAN_2 = MINUTE_10.TEMPERATURE_AIR_MEAN_2
        TEMPERATURE_AIR_MIN_0_05 = MINUTE_10.TEMPERATURE_AIR_MIN_0_05
        TEMPERATURE_AIR_MIN_2 = MINUTE_10.TEMPERATURE_AIR_MIN_2
        TEMPERATURE_SOIL_MEAN_0_1 = MINUTE_10.TEMPERATURE_SOIL_MEAN_0_1
        TEMPERATURE_SOIL_MEAN_0_2 = MINUTE_10.TEMPERATURE_SOIL_MEAN_0_2
        TEMPERATURE_SOIL_MEAN_0_5 = MINUTE_10.TEMPERATURE_SOIL_MEAN_0_5
        ...
        WIND_SPEED_MEAN_1000 = MINUTE_10.WIND_SPEED_MEAN_10
    ...
    class HOURLY(DatasetTreeCore):
        class HOURLY(Enum):
            ...
            TEMPERATURE_AIR_MEAN_2 = "tl"  # Lufttemperatur 2 meter °C
            TEMPERATURE_AIR_MIN_0_05 = "tsmin"  # Lufttemperatur 5cm Minimalwert °C
            TEMPERATURE_SOIL_MEAN_0_1 = "tb10"  # Erdbodentemperatur in 10 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_2 = "tb20"  # Erdbodentemperatur in 20 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_5 = "tb50"  # Erdbodentemperatur in 50 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_1 = "tb100"  # Erdbodentemperatur in 100 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_2 = "tb200"  # Erdbodentemperatur in 200 cm Tiefe °C
        ...
        TEMPERATURE_AIR_MEAN_2 = HOURLY.TEMPERATURE_AIR_MEAN_2
        TEMPERATURE_AIR_MIN_0_05 = HOURLY.TEMPERATURE_AIR_MIN_0_05
        TEMPERATURE_SOIL_MEAN_0_1 = HOURLY.TEMPERATURE_SOIL_MEAN_0_1
        TEMPERATURE_SOIL_MEAN_0_2 = HOURLY.TEMPERATURE_SOIL_MEAN_0_2
        TEMPERATURE_SOIL_MEAN_0_5 = HOURLY.TEMPERATURE_SOIL_MEAN_0_5
        TEMPERATURE_SOIL_MEAN_1 = HOURLY.TEMPERATURE_SOIL_MEAN_1
        TEMPERATURE_SOIL_MEAN_2 = HOURLY.TEMPERATURE_SOIL_MEAN_2
    ...
    class DAILY(DatasetTreeCore):
        class DAILY(Enum):
            ...
            TEMPERATURE_AIR_MAX_2 = "tlmax"  # Lufttemperatur 2m Maximum °C
            TEMPERATURE_AIR_MEAN_2 = "tl_mittel"  # Lufttemperaturmittel 2m °C
            TEMPERATURE_AIR_MIN_2 = "tlmin"  # Lufttemperatur 2m Minimum °C
            TEMPERATURE_AIR_MIN_0_05 = "tsmin"  # 5 cm Lufttemperatur Minimum °C
            WIND_GUST_MAX = "ffx"  # Maximale Windgeschwindigkeit (Spitzenböe) m/s
        ...
        TEMPERATURE_AIR_MAX_2 = DAILY.TEMPERATURE_AIR_MAX_2
        TEMPERATURE_AIR_MEAN_2 = DAILY.TEMPERATURE_AIR_MEAN_2
        TEMPERATURE_AIR_MIN_2 = DAILY.TEMPERATURE_AIR_MIN_2
        TEMPERATURE_AIR_MIN_0_05 = DAILY.TEMPERATURE_AIR_MIN_0_05
    ...
    class MONTHLY(DatasetTreeCore):
        class MONTHLY(Enum):
            ...
            TEMPERATURE_CONCRETE_MAX_0 = "bet0_max"  # Lufttemperatur Beton 0cm Monatsmaximal °C
            TEMPERATURE_AIR_MEAN_2 = "tl_mittel"  # Lufttemperatur 2m Monatsmittel °C
            TEMPERATURE_CONCRETE_MEAN_0 = "bet0"  # Lufttemperatur Beton 0cm Monatsmittel °C
            TEMPERATURE_AIR_MIN_2 = "tlmin"  # Lufttemperatur 2m Monatsminimum °C
            TEMPERATURE_CONCRETE_MIN_0 = "bet0_min"  # Lufttemperatur Beton 0cm Monatsminimum °C
            TEMPERATURE_SOIL_MAX_0_1 = "tb10_max"  # Erdbodentemperatur -10cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_0_2 = "tb20_max"  # Erdbodentemperatur -20cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_0_5 = "tb50_max"  # Erdbodentemperatur -50cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_1 = "tb100_max"  # Erdbodentemperatur -100cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_2 = "tb200_max"  # Erdbodentemperatur -200cm Monatsmaximum °C
            TEMPERATURE_SOIL_MEAN_0_1 = "tb10_mittel"  # Erdbodentemperatur -10cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_0_2 = "tb20_mittel"  # Erdbodentemperatur -20cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_0_5 = "tb50_mittel"  # Erdbodentemperatur -50cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_1 = "tb100_mittel"  # Erdbodentemperatur -100cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_2 = "tb200_mittel"  # Erdbodentemperatur -200cm Monatsmittel °C
            TEMPERATURE_SOIL_MIN_0_1 = "tb10_min"  # Erdbodentemperatur -10cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_0_2 = "tb20_min"  # Erdbodentemperatur -20cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_0_5 = "tb50_min"  # Erdbodentemperatur -50cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_1 = "tb100_min"  # Erdbodentemperatur -100cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_2 = "tb200_min"  # Erdbodentemperatur -200cm Monatsminimum °C
        ...
        TEMPERATURE_AIR_MAX_2 = MONTHLY.TEMPERATURE_AIR_MAX_2
        TEMPERATURE_CONCRETE_MAX_0 = MONTHLY.TEMPERATURE_CONCRETE_MAX_0
        TEMPERATURE_AIR_MEAN_2 = MONTHLY.TEMPERATURE_AIR_MEAN_2
        TEMPERATURE_CONCRETE_MEAN_0 = MONTHLY.TEMPERATURE_CONCRETE_MEAN_0
        TEMPERATURE_AIR_MIN_2 = MONTHLY.TEMPERATURE_AIR_MIN_2
        TEMPERATURE_CONCRETE_MIN_0 = MONTHLY.TEMPERATURE_CONCRETE_MIN_0
        TEMPERATURE_SOIL_MAX_0_1 = MONTHLY.TEMPERATURE_SOIL_MAX_0_1
        TEMPERATURE_SOIL_MAX_0_2 = MONTHLY.TEMPERATURE_SOIL_MAX_0_2
        TEMPERATURE_SOIL_MAX_0_5 = MONTHLY.TEMPERATURE_SOIL_MAX_0_5
        TEMPERATURE_SOIL_MAX_1 = MONTHLY.TEMPERATURE_SOIL_MAX_1
        TEMPERATURE_SOIL_MAX_2 = MONTHLY.TEMPERATURE_SOIL_MAX_2
        TEMPERATURE_SOIL_MEAN_0_1 = MONTHLY.TEMPERATURE_SOIL_MEAN_0_1
        TEMPERATURE_SOIL_MEAN_0_2 = MONTHLY.TEMPERATURE_SOIL_MEAN_0_2
        TEMPERATURE_SOIL_MEAN_0_5 = MONTHLY.TEMPERATURE_SOIL_MEAN_0_5
        TEMPERATURE_SOIL_MEAN_1 = MONTHLY.TEMPERATURE_SOIL_MEAN_1
        TEMPERATURE_SOIL_MEAN_2 = MONTHLY.TEMPERATURE_SOIL_MEAN_2
        TEMPERATURE_SOIL_MIN_0_1 = MONTHLY.TEMPERATURE_SOIL_MIN_0_1
        TEMPERATURE_SOIL_MIN_0_2 = MONTHLY.TEMPERATURE_SOIL_MIN_0_2
        TEMPERATURE_SOIL_MIN_0_5 = MONTHLY.TEMPERATURE_SOIL_MIN_0_5
        TEMPERATURE_SOIL_MIN_1 = MONTHLY.TEMPERATURE_SOIL_MIN_1
        TEMPERATURE_SOIL_MIN_2 = MONTHLY.TEMPERATURE_SOIL_MIN_2
...
class GeosphereObservationUnit(DatasetTreeCore):
    class MINUTE_10(DatasetTreeCore):
        class MINUTE_10(UnitEnum):
            ...
            TEMPERATURE_AIR_MAX_0_05 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MAX_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MEAN_0_05 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MEAN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MIN_0_05 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MIN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_5 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
    ...
    class HOURLY(DatasetTreeCore):
        class HOURLY(UnitEnum):
            ...
            TEMPERATURE_SOIL_MEAN_0_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_5 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            WIND_DIRECTION = OriginUnit.DEGREE.value, SIUnit.DEGREE.value
            WIND_DIRECTION_GUST_MAX = OriginUnit.DEGREE.value, SIUnit.DEGREE.value
            WIND_GUST_MAX = OriginUnit.METER_PER_SECOND.value, SIUnit.METER_PER_SECOND.value
            WIND_SPEED = OriginUnit.METER_PER_SECOND.value, SIUnit.METER_PER_SECOND.value
...
=======
            ...
            TEMPERATURE_AIR_MIN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MIN_0_05 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
>>>>>>> 8e1935be (updated parameter names)
            WIND_GUST_MAX = OriginUnit.METER_PER_SECOND.value, SIUnit.METER_PER_SECOND.value
            WIND_SPEED = OriginUnit.METER_PER_SECOND.value, SIUnit.METER_PER_SECOND.value
    ...
    class MONTHLY(DatasetTreeCore):
        class MONTHLY(UnitEnum):
            ...
            TEMPERATURE_AIR_MAX_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_CONCRETE_MAX_0 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MEAN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_CONCRETE_MEAN_0 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_AIR_MIN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_CONCRETE_MIN_0 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value            
            TEMPERATURE_SOIL_MAX_0_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MAX_0_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MAX_0_5 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MAX_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MAX_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_0_5 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MEAN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MIN_0_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MIN_0_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MIN_0_5 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MIN_1 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            TEMPERATURE_SOIL_MIN_2 = OriginUnit.DEGREE_CELSIUS.value, SIUnit.DEGREE_KELVIN.value
            WIND_SPEED = OriginUnit.METER_PER_SECOND.value, SIUnit.METER_PER_SECOND.value
