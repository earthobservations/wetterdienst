...
class GeosphereObservationParameter(DatasetTreeCore):
    class MINUTE_10(DatasetTreeCore):
        class MINUTE_10(Enum):
            ...
            TEMPERATURE_AIR_MIN_2M = "TLMIN"  # Lufttemperaturminimum in 2m °C
            TEMPERATURE_DEW_POINT_MEAN_2M = "TP"  # Taupunkt °C
            TEMPERATURE_SOIL_MEAN_0_1M = "TB1"  # Erdbodentemperatur in 10cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_2M = "TB2"  # Erdbodentemperatur in 20cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_5M = "TB3"  # Erdbodentemperatur in 50cm Tiefe °C
    ...
    class HOURLY(DatasetTreeCore):
        class HOURLY(Enum):
            ...
            TEMPERATURE_AIR_MEAN_0_05M = "LT2"  # LT2 Lufttemperatur in 5 cm °C
            TEMPERATURE_AIR_MEAN_2M = "TTX"  # Lufttemperatur 2 meter °C
            TEMPERATURE_SOIL_MEAN_0_1M = "TT2"  # Erdbodentemperatur in 10 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_2M = "TT3"  # Erdbodentemperatur in 20 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_0_5M = "TT4"  # Erdbodentemperatur in 50 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_1M = "TT5"  # Erdbodentemperatur in 100 cm Tiefe °C
            TEMPERATURE_SOIL_MEAN_2M = "TT0"  # Erdbodentemperatur in 200 cm Tiefe °C
            TEMPERATURE_DEW_POINT_MEAN_2M = "TDX"  # Taupunktstemperatur °C
        ...
        TEMPERATURE_AIR_MEAN_0_05M = HOURLY.TEMPERATURE_AIR_MEAN_0_05M
    ...
    class DAILY(DatasetTreeCore):
        class DAILY(Enum):
            ...
            TEMPERATURE_AIR_MAX_2M = "tmax"  # Lufttemperatur 2m Maximum °C
            TEMPERATURE_AIR_MEAN_2M = "t"  # Lufttemperaturmittel 2m °C
            TEMPERATURE_AIR_MIN_2M = "tmin"  # Lufttemperatur 2m Minimum °C
            TEMPERATURE_AIR_MIN_0_05M = "erdmin"  # 5 cm Lufttemperatur Minimum °C
    ...
    class MONTHLY(DatasetTreeCore):
        class MONTHLY(Enum):
            ...
            TEMPERATURE_AIR_MAX_2M = "tmax"  # Lufttemperatur 2m Monatsmaximum °C
            TEMPERATURE_AIR_MAX_2M_MEAN = "mtmax"  # Lufttemperatur 2m Monatsmittel aller Tagesmaxima °C
            TEMPERATURE_AIR_MEAN_0_05M = "t5m"  # Lufttemperatur +5cm Monatsmittel °C
            TEMPERATURE_AIR_MEAN_2M = "t"  # Lufttemperatur 2m Monatsmittel °C
            TEMPERATURE_AIR_MIN_0_05M = "t5min"  # Lufttemperatur +5cm Monatsminimum °C
            TEMPERATURE_AIR_MIN_2M = "tmin"  # Lufttemperatur 2m Monatsminimum °C
            TEMPERATURE_AIR_MIN_2M_MEAN = "mtmin"  # Lufttemperatur 2m Monatsmittel aller Tagesminima °C
            TEMPERATURE_DEW_POINT_MEAN_2M = "Tautemp"  # Taupunkt Monatsmittel °C
            TEMPERATURE_SOIL_MAX_0_1M = "maxe10"  # Erdbodentemperatur -10cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_0_2M = "maxe20"  # Erdbodentemperatur -20cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_0_5M = "maxe50"  # Erdbodentemperatur -50cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_1M = "maxe100"  # Erdbodentemperatur -100cm Monatsmaximum °C
            TEMPERATURE_SOIL_MAX_2M = "maxe200"  # Erdbodentemperatur -200cm Monatsmaximum °C
            TEMPERATURE_SOIL_MEAN_0_1M = "e10"  # Erdbodentemperatur -10cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_0_2M = "e20"  # Erdbodentemperatur -20cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_0_5M = "e50"  # Erdbodentemperatur -50cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_1M = "e100"  # Erdbodentemperatur -100cm Monatsmittel °C
            TEMPERATURE_SOIL_MEAN_2M = "e200"  # Erdbodentemperatur -200cm Monatsmittel °C
            TEMPERATURE_SOIL_MIN_0_1M = "mine10"  # Erdbodentemperatur -10cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_0_2M = "mine20"  # Erdbodentemperatur -20cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_0_5M = "mine50"  # Erdbodentemperatur -50cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_1M = "mine100"  # Erdbodentemperatur -100cm Monatsminimum °C
            TEMPERATURE_SOIL_MIN_2M = "mine200"  # Erdbodentemperatur -200cm Monatsminimum °C
        ...
        TEMPERATURE_AIR_MEAN_0_05M = MONTHLY.TEMPERATURE_AIR_MEAN_0_05M
        TEMPERATURE_AIR_MEAN_2M = MONTHLY.TEMPERATURE_AIR_MEAN_2M
        TEMPERATURE_AIR_MIN_0_05M = MONTHLY.TEMPERATURE_AIR_MIN_0_05M
        TEMPERATURE_AIR_MIN_2M = MONTHLY.TEMPERATURE_AIR_MIN_2M
        TEMPERATURE_AIR_MIN_2M_MEAN = MONTHLY.TEMPERATURE_AIR_MIN_2M_MEAN
        TEMPERATURE_DEW_POINT_MEAN_2M = MONTHLY.TEMPERATURE_DEW_POINT_MEAN_2M
