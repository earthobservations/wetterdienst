...
class DwdObservationParameter(DatasetTreeCore):
    ...
    class MINUTE_10(DatasetTreeCore):  # noqa
        ...
        class TEMPERATURE_AIR(Enum):  # noqa
            ...
            TEMPERATURE_AIR_MEAN_2M = "tt_10"
            TEMPERATURE_AIR_MEAN_0_05M = "tm5_10"
            HUMIDITY = "rf_10"
            TEMPERATURE_DEW_POINT_MEAN_2M = "td_10"
        ...
        class TEMPERATURE_EXTREME(Enum):  # noqa
            QUALITY = "qn"
            TEMPERATURE_AIR_MAX_2M = "tx_10"
            TEMPERATURE_AIR_MAX_0_05M = "tx5_10"
            TEMPERATURE_AIR_MIN_2M = "tn_10"
            TEMPERATURE_AIR_MIN_0_05M = "tn5_10"
        ...
        TEMPERATURE_AIR_MEAN_2M = TEMPERATURE_AIR.TEMPERATURE_AIR_MEAN_2M
        TEMPERATURE_AIR_MEAN_0_05M = TEMPERATURE_AIR.TEMPERATURE_AIR_MEAN_0_05M
        HUMIDITY = TEMPERATURE_AIR.HUMIDITY
        TEMPERATURE_DEW_POINT_MEAN_2M = TEMPERATURE_AIR.TEMPERATURE_DEW_POINT_MEAN_2M

        # extreme_temperature
        TEMPERATURE_AIR_MAX_2M = TEMPERATURE_EXTREME.TEMPERATURE_AIR_MAX_2M
        TEMPERATURE_AIR_MAX_0_05M = TEMPERATURE_EXTREME.TEMPERATURE_AIR_MAX_0_05M
        TEMPERATURE_AIR_MIN_2M = TEMPERATURE_EXTREME.TEMPERATURE_AIR_MIN_2M
        TEMPERATURE_AIR_MIN_0_05M = TEMPERATURE_EXTREME.TEMPERATURE_AIR_MIN_0_05M
    ...
    class HOURLY(DatasetTreeCore):
        ...
        class MOISTURE(Enum):
            ...
            TEMPERATURE_WET_MEAN_2M = "tf_std"
            PRESSURE_AIR_SITE = "p_std"
            TEMPERATURE_AIR_MEAN_2M = "tt_std"
            HUMIDITY = "rf_std"
            TEMPERATURE_DEW_POINT_MEAN_2M = "td_std"
        ...
        class TEMPERATURE_SOIL(Enum):  # noqa
            QUALITY = "qn_2"
            TEMPERATURE_SOIL_MEAN_0_02M = "v_te002"
            TEMPERATURE_SOIL_MEAN_0_05M = "v_te005"
            TEMPERATURE_SOIL_MEAN_0_1M = "v_te010"
            TEMPERATURE_SOIL_MEAN_0_2M = "v_te020"
            TEMPERATURE_SOIL_MEAN_0_5M = "v_te050"
            TEMPERATURE_SOIL_MEAN_1M = "v_te100"
        ...
        class URBAN_TEMPERATURE_SOIL(Enum):  # noqa
            QUALITY = "qualitaets_niveau"
            TEMPERATURE_SOIL_MEAN_0_05M = "erdbt_005"
            TEMPERATURE_SOIL_MEAN_0_1M = "erdbt_010"
            TEMPERATURE_SOIL_MEAN_0_2M = "erdbt_020"
            TEMPERATURE_SOIL_MEAN_0_5M = "erdbt_050"
            TEMPERATURE_SOIL_MEAN_1M = "erdbt_100"
        ...
        # dew_point
        TEMPERATURE_DEW_POINT_MEAN_2M = DEW_POINT.TEMPERATURE_DEW_POINT_MEAN_2M
        ...
        TEMPERATURE_WET_MEAN_2M = MOISTURE.TEMPERATURE_WET_MEAN_2M
        ...
        # soil_temperature
        TEMPERATURE_SOIL_MEAN_0_02M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_0_02M
        TEMPERATURE_SOIL_MEAN_0_05M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_0_05M
        TEMPERATURE_SOIL_MEAN_0_1M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_0_1M
        TEMPERATURE_SOIL_MEAN_0_2M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_0_2M
        TEMPERATURE_SOIL_MEAN_0_5M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_0_5M
        TEMPERATURE_SOIL_MEAN_1M = TEMPERATURE_SOIL.TEMPERATURE_SOIL_MEAN_1M
    ...
    class SUBDAILY(DatasetTreeCore):  # noqa
        ...
        class MOISTURE(Enum):
            ...
            TEMPERATURE_AIR_MEAN_0_05M = "e_tf_ter"
            TEMPERATURE_AIR_MEAN_2M = "tf_ter"
            HUMIDITY = "rf_ter"
        ...
        class SOIL(Enum):
            QUALITY = "qn_4"
            TEMPERATURE_SOIL_MEAN_0_05M = "ek_ter"  # int

        # air_temperature
        class TEMPERATURE_AIR(Enum):  # noqa
            QUALITY = "qn_4"
            TEMPERATURE_AIR_MEAN_2M = "tt_ter"
            HUMIDITY = "rf_ter"
        ...
        # moisture
        PRESSURE_VAPOR = MOISTURE.PRESSURE_VAPOR
        TEMPERATURE_AIR_MEAN_0_05M = MOISTURE.TEMPERATURE_AIR_MEAN_0_05M

        # pressure
        PRESSURE_AIR_SITE = PRESSURE.PRESSURE_AIR_SITE

        # soil
        TEMPERATURE_SOIL_MEAN_0_05M = SOIL.TEMPERATURE_SOIL_MEAN_0_05M
    ...
    class DAILY(DatasetTreeCore):
        ...
        class CLIMATE_SUMMARY(Enum):  # noqa
            ...
            TEMPERATURE_AIR_MEAN_2M = "tmk"
            HUMIDITY = "upm"
            TEMPERATURE_AIR_MAX_2M = "txk"
            TEMPERATURE_AIR_MIN_2M = "tnk"
            TEMPERATURE_AIR_MIN_0_05M = "tgk"
        ...
        class TEMPERATURE_SOIL(Enum):  # noqa
            QUALITY = "qn_2"
            TEMPERATURE_SOIL_MEAN_0_02M = "v_te002m"
            TEMPERATURE_SOIL_MEAN_0_05M = "v_te005m"
            TEMPERATURE_SOIL_MEAN_0_1M = "v_te010m"
            TEMPERATURE_SOIL_MEAN_0_2M = "v_te020m"
            TEMPERATURE_SOIL_MEAN_0_5M = "v_te050m"
            TEMPERATURE_SOIL_MEAN_1M = "v_te100m"
        ...
        TEMPERATURE_AIR_MEAN_2M = CLIMATE_SUMMARY.TEMPERATURE_AIR_MEAN_2M
        HUMIDITY = CLIMATE_SUMMARY.HUMIDITY
        TEMPERATURE_AIR_MAX_2M = CLIMATE_SUMMARY.TEMPERATURE_AIR_MAX_2M
        TEMPERATURE_AIR_MIN_2M = CLIMATE_SUMMARY.TEMPERATURE_AIR_MIN_2M
        TEMPERATURE_AIR_MIN_0_05M = CLIMATE_SUMMARY.TEMPERATURE_AIR_MIN_0_05M
    ...
    class MONTHLY(DatasetTreeCore):
        ...
        class CLIMATE_SUMMARY(Enum):  # noqa
            ...
            TEMPERATURE_AIR_MEAN_2M = "mo_tt"
            TEMPERATURE_AIR_MAX_2M_MEAN = "mo_tx"
            TEMPERATURE_AIR_MIN_2M_MEAN = "mo_tn"
            SUNSHINE_DURATION = "mo_sd_s"
            WIND_FORCE_BEAUFORT = "mo_fk"
            TEMPERATURE_AIR_MAX_2M = "mx_tx"
            WIND_GUST_MAX = "mx_fx"
            TEMPERATURE_AIR_MIN_2M = "mx_tn"
        ...
        CLOUD_COVER_TOTAL = CLIMATE_SUMMARY.CLOUD_COVER_TOTAL
        TEMPERATURE_AIR_MEAN_2M = CLIMATE_SUMMARY.TEMPERATURE_AIR_MEAN_2M
        TEMPERATURE_AIR_MAX_2M_MEAN = CLIMATE_SUMMARY.TEMPERATURE_AIR_MAX_2M_MEAN
        TEMPERATURE_AIR_MIN_2M_MEAN = CLIMATE_SUMMARY.TEMPERATURE_AIR_MIN_2M_MEAN
    ...
    class ANNUAL(DatasetTreeCore):
        ...
        class CLIMATE_SUMMARY(Enum):  # noqa
            ...
            TEMPERATURE_AIR_MEAN_2M = "ja_tt"
            TEMPERATURE_AIR_MAX_2M_MEAN = "ja_tx"
            TEMPERATURE_AIR_MIN_2M_MEAN = "ja_tn"
            SUNSHINE_DURATION = "ja_sd_s"
            WIND_FORCE_BEAUFORT = "ja_fk"
            WIND_GUST_MAX = "ja_mx_fx"
            TEMPERATURE_AIR_MAX_2M = "ja_mx_tx"
            TEMPERATURE_AIR_MIN_2M = "ja_mx_tn"
            QUALITY_PRECIPITATION = "qn_6"
