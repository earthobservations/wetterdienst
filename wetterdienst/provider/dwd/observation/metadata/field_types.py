...
INTEGER_PARAMETERS = {
    ...
    # weather_phenomena
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_FOG.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_THUNDER.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STRONG_WIND.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STORMIER_WIND.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_DEW.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_GLAZE.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_RIPE.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_SLEET.value,
    DwdObservationDatasetTree.DAILY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_HAIL.value,
    # monthly
    # more_precip
    ...
    # weather_phenomena
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STRONG_WIND.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STORMIER_WIND.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_THUNDER.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_GLAZE.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_SLEET.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_HAIL.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_FOG.value,
    DwdObservationDatasetTree.MONTHLY.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_DEW.value,
    # annual
    # more_precip
    ...
    # weather_phenomena
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STRONG_WIND.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_STORM_STORMIER_WIND.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_THUNDER.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_GLAZE.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_SLEET.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_HAIL.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_FOG.value,
    DwdObservationDatasetTree.ANNUAL.WEATHER_PHENOMENA.COUNT_WEATHER_TYPE_DEW.value,
}
STRING_PARAMETERS = {
    # hourly
    # cloud_type
