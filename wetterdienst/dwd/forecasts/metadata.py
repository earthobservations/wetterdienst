...
class DWDForecastsDataColumns(WDDataColumnBase):
    class HOURLY(WDDataColumnBase):
        class CLIMATE_SUMMARY(Enum):  # noqa
            ...
            PRECIPITATION_CONSIST_LAST_1H = "PRECIPITATION_CONSIST_LAST_1H"
            PRECIPITATION_LAST_1H = "PRECIPITATION_LAST_1H"
            PRECIPITATION_CONSIST_LAST_3H = "PRECIPITATION_CONSIST_LAST_3H"
            PRECIPITATION_LAST_3H = "PRECIPITATION_LAST_3H"
            PRECIPITATION_SNOW_EQUIV_LAST_1H = "PRECIPITATION_SNOW_EQUIV_LAST_1H"
            PRECIPITATION_SNOW_EQUIV_LAST_3H = "PRECIPITATION_SNOW_EQUIV_LAST_3H"
            ...
            PRESSURE_AIR_SURFACE_REDUCED = "PRESSURE_AIR_SURFACE_REDUCED"
            TEMPERATURE_AIR_005 = "TEMPERATURE_AIR_005"
            RADIATION_SHORT_WAVE_BALANCE_LAST_3H = "RADIATION_SHORT_WAVE_BALANCE_LAST_3H"
            RADIATION_GLOBAL = "RADIATION_GLOBAL"
            RADIATION_LONG_WAVE_BALANCE_LAST_3H = "RADIATION_LONG_WAVE_BALANCE_LAST_3H"
            ...
            PROBABILITY_FOG_LAST_1H = "PROBABILITY_FOG"
            PROBABILITY_FOG_LAST_6H = "PROBABILITY_FOG_LAST_6H"
            PROBABILITY_FOG_LAST_12H = "PROBABILITY_FOG_LAST_12H"
            PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_12H = "PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_12H"
            PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_6H = "PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_6H"
            PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_12H = "PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_12H"
            PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_24H = "PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_24H"
            PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_12H = "PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_12H"
            PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_6H = "PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_6H"
            PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_12H = "PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_12H"
            PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_24H = "PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_24H"
            TEMPERATURE_AIR_MIN_005_LAST_12H = "TEMPERATURE_AIR_MIN_005_LAST_12H"
            TEMPERATURE_AIR_200_LAST_24H = "TEMPERATURE_AIR_200_LAST_24H"
            PRECIPITATION_DURATION = "PRECIPITATION_DURATION"
            PROBABILITY_DRIZZLE_LAST_1H = "PROBABILITY_DRIZZLE_LAST_1H"
            PROBABILITY_PRECIPITATION_STRAT_LAST_1H = "PROBABILITY_PRECIPTATION_STRAT_LAST_1H"
            PROBABILITY_PRECIPITATION_CONV_LAST_1H = "PROBABILITY_PRECIPITATION_CONV_LAST_1H"
            PROBABILITY_THUNDERSTORM_LAST_1H = "PROBABILITY_THUNDERSTORM_LAST_1H"
            ...
            ERROR_ABSOLUTE_TEMPERATURE_AIR_200 = "ERROR_ABSOLUTE_TEMPERATURE_AIR_200"
            ERROR_ABSOLUTE_WIND_SPEED = "ERROR_ABSOLUTE_WIND_SPEED"
            ERROR_ABSOLUTE_WIND_DIRECTION = "ERROR_ABSOLUTE_WIND_DIRECTION"
            ERROR_ABSOLUTE_TEMPERATURE_DEW_POINT_200 = "ERROR_ABSOLUTE_TEMPERATURE_DEW_POINT_200"
            PRECIPITATION_LAST_6H = "PRECIPITATION_LAST_6H"
            PRECIPITATION_CONSIST_LAST_6H = "PRECIPITATION_CONSIST_LAST_6H"
            PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_6H = "PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_6H"
            PROBABILITY_PRECIPITATION_GT_0_1_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_0_1_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_0_2_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_0_3_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_0_3_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_0_5_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_0_5_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_0_7_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_0_7_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_2_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_2_0_MM_LAST_1H"
            ...
            PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_0_PCT_LAST_24H = "PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_0_PCT_LAST_24H"
            PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_30_PCT_LAST_24H = "PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_30_PCT_LAST_24H"
            PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_60_PCT_LAST_24H = "PROBABILITY_SUNSHINE_DURATION_RELATIVE_GT_60_PCT_LAST_24H"
            ...
            PROBABILITY_PRECIPITATION_GT_3_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_3_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_5_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_10_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_10_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_15_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_15_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_25_0_MM_LAST_1H = "PROBABILITY_PRECIPITATION_GT_25_0_MM_LAST_1H"
            PROBABILITY_PRECIPITATION_STRAT_LAST_6H = "PROBABILITY_PRECIPITATION_STRAT_LAST_6H"
            PROBABILITY_PRECIPITATION_CONV_LAST_6H = "PROBABILITY_PRECIPITATION_CONV_LAST_6H"
            PROBABILITY_THUNDERSTORM_LAST_6H = "PROBABILITY_THUNDERSTORM_LAST_6H"
            ...
            PROBABILITY_PRECIPITATION_STRAT_LAST_12H = "PROBABILITY_PRECIPITATION_STRAT_LAST_12H"
            PROBABILITY_PRECIPITATION_CONV_LAST_12H = "PROBABILITY_PRECIPITATION_CONV_LAST_12H"
            PROBABILITY_THUNDERSTORM_LAST_12H = "PROBABILITY_THUNDERSTORM_LAST_12H"
            ...
            PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_6H = "PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_6H"
            PRECIPITATION_LAST_12H = "PRECIPITATION_LAST_12H"
            PRECIPITATION_CONSIST_LAST_12H = "PRECIPITATION_CONSIST_LAST_12H"
            WEATHER_SIGNIFICANT_LAST_3H = "WEATHER_SIGN_LAST_3H"
            PRECIPITATION_LIQUID_CONSIST_LAST_1H = "PRECIPITATION_LIQUID_CONSIST_LAST_1H"
            PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_24H = "PROBABILITY_PRECIPITATION_GT_0_0_MM_LAST_24H"
            PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_24H = "PROBABILITY_PRECIPITATION_GT_1_0_MM_LAST_24H"
            PRECIPITATION_LAST_24H = "PRECIPITATION_LAST_24H"
            PRECIPITATION_CONSIST_LAST_24H = "PRECIPITATION_CONSIST_LAST_24H"
            CLOUD_COVER_BELOW_7000_M = "CLOUD_COVER_BELOW_7000_M"
            PROBABILITY_PRECIPITATION_LAST_24H = "wwPd"
            CLOUD_BASE_CONVECTIVE = "CLOUD_BASE_CONVECTIVE"
            PROBABILITY_THUNDERSTORM_LAST_24H = "PROBABILITY_THUNDERSTORM_LAST_24H"
            ERROR_ABSOLUTE_PRESSURE_AIR_SURFACE = "ERROR_ABSOLUTE_PRESSURE_AIR_SURFACE"
