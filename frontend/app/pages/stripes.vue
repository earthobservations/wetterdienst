...
const stripesUrl = computed(() => {
  ...
  if (startYear.value) params.set('start_year', String(startYear.value))
  if (endYear.value) params.set('end_year', String(endYear.value))
...
<template>
  <div class="max-w-6xl mx-auto py-8 px-4">
    <div class="text-center mb-8">
      <h1 class="text-4xl font-bold mb-4">Climate Stripes</h1>
    ...
    <UCard class="mt-8">
      <template #header>
        <h2 class="text-lg font-semibold">About Climate Stripes</h2>
      </template>
