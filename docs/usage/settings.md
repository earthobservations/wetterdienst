...
| ts_geo_station_distance            | dictionary of per-parameter overrides of the two distances above, e.g. `{"precipitation_height": 25.0}`, keyed by canonical parameter name. Used exactly as given, at every resolution                                                                                                                                                              | {}      |
| ts_geo_station_distance_resolution_factors | dictionary of factors the heterogeneous distance is multiplied by, keyed by resolution, e.g. `{"daily": 3.0}`. Resolutions left out keep their default factor: 0.75 for the minute resolutions, 1.0 hourly, 1.5 for `6_hour` and `subdaily`, 2.0 daily, 3.0 monthly and annual                                                          | {}      |
