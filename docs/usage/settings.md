...
| ts_geo_station_distance            | dictionary of per-parameter overrides of the two distances above, e.g. `{"precipitation_height": 25.0}`, keyed by canonical parameter name                                                                                                                                                                                                          | {}      |
