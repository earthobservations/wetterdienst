...
| temperature_air_mean_2m     | ja_tt         | annual mean of daily temperature means in 2m height     | K     | °C            | -           |
| temperature_air_max_2m_mean | ja_tx         | annual mean of daily temperature maxima in 2m height    | K     | °C            | -           |
| temperature_air_min_2m_mean | ja_tn         | annual mean of daily temperature minima in 2m height    | K     | °C            | -           |
...
| temperature_air_max_2m      | ja_mx_tx      | annual maximum of daily temperature maxima in 2m height | K     | °C            | -           |
| wind_gust_max               | ja_mx_fx      | annual maximum of daily wind speed                      | Bft   | Bft           | >=0         |
| temperature_air_min_2m      | ja_mx_tn      | annual minimum of daily temperature minima in 2m height | K     | °C            | -           |
