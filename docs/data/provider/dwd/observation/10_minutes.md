...
|----------------------------|---------------|------------------------------------------------------|-------|---------------|-------------|
| precipitation_duration     | rws_dau_10    | duration of precipitation within the last 10 minutes | s     | min           | >=0         |
| precipitation_height       | rws_10        | precipitation height of the last 10 minutes          | kg/m² | mm            | >=0         |
| precipitation_indicator_wr | rws_ind_10    | precipitation index                                  | -     | -             | ∈ \[0,1,3\] |
...
| name                             | original name | description                              | unit | original unit | constraints |
|----------------------------------|---------------|------------------------------------------|------|---------------|-------------|
| radiation_sky_short_wave_diffuse | ds_10         | 10min-sum of diffuse solar radiation     | J/m² | J/cm²         | >=0         |
| radiation_global                 | gs_10         | 10min-sum of solar incoming radiation    | J/m² | J/cm²         | >=0         |
| sunshine_duration                | sd_10         | 10min-sum of sunshine duration           | s    | h             | >=0         |
| radiation_sky_long_wave          | ls_10         | 10min-sum of longwave downward radiation | J/m² | J/cm²         | >=0         |
...
| name                          | original name | description                                                                                                                         | unit | original unit | constraints |
|-------------------------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------|------|---------------|-------------|
| pressure_air_site             | pp_10         | pressure at station height                                                                                                          | Pa   | hPa           | >=0         |
| temperature_air_mean_2m       | tt_10         | air temperature at 2m height                                                                                                        | K    | °C            | -           |
| temperature_air_mean_0_05m    | tm5_10        | air temperature at 5cm height                                                                                                       | K    | °C            | -           |
| humidity                      | rf_10         | relative humidity at 2m height                                                                                                      | %    | %             | >=0,<=100   |
| temperature_dew_point_mean_2m | td_10         | dew point temperature at 2m height, the dew point temperature is calculated from the temperature and relative humidity measurements | K    | °C            | -           |
...
| name                      | original name | description                                                         | unit | original unit | constraints |
|---------------------------|---------------|---------------------------------------------------------------------|------|---------------|-------------|
| temperature_air_max_2m    | tx_10         | maximum of air temperature at 2m height during the last 10 minutes  | K    | °C            | -           |
| temperature_air_max_0_05m | tx5_10        | maximum of air temperature at 5cm height during the last 10 minutes | K    | °C            | -           |
| temperature_air_min_2m    | tn_10         | minimum of air temperature at 2m height during the last 10 minutes  | K    | °C            | -           |
| temperature_air_min_0_05m | tn5_10        | minimum of air temperature at 5cm height during the last 10 minutes | K    | °C            | -           |
...
| name           | original name | description                                       | unit | original unit | constraints |
|----------------|---------------|---------------------------------------------------|------|---------------|-------------|
| wind_speed     | ff_10         | mean of wind speed during the last 10 minutes     | m/s  | m/s           | >=0         |
| wind_direction | dd_10         | mean of wind direction during the last 10 minutes | °    | °             | >=0,<=360   |
...
| name                        | original name | description                                                                                                                                                                                                                                                    | unit | original unit | constraints |
|-----------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|---------------|-------------|
| wind_gust_max               | fx_10         | maximum wind gust of the last 10 minutes, the instrument samples the instantaneous wind velocity every 0.25 seconds, and writes out the max value of a 3 second period, the highest occuring within the 10min interval is given here as the maximum wind gust. | m/s  | m/s           | >=0         |
| wind_speed_min              | fnx_10        | minimum 10-minute mean wind velocity. The 10-minutes interval is moved in 10s steps over the last 20 minutes                                                                                                                                                   | m/s  | m/s           | >=0         |
| wind_speed_rolling_mean_max | fmx_10        | maximum 10-minute mean wind velocity. The 10-minutes interval is moved in 10s steps over the last 20 minutes                                                                                                                                                   | m/s  | m/s           | >=0         |
| wind_direction_gust_max     | dx_10         | wind direction of highest wind gust                                                                                                                                                                                                                            | °    | °             | >=0,<=360   |
