...
| {term}`cooling_degree_hour`        | Kuehlgradstunden    | accumulated hourly temperature differences between air temperature and reference temperature            | °Cd           | >=0         |
...
| name                                                     | original name        | description                                                   | unit | constraints |
|----------------------------------------------------------|----------------------|---------------------------------------------------------------|------|-------------|
| {term}`temperature_soil_mean_0_05m`                      | mittel von ts05      | mean soil temperature at 0.05m depth                          | °C   | -           |
| {term}`temperature_soil_mean_0_1m`                       | mittel von ts10      | mean soil temperature at 0.1m depth                           | °C   | -           |
