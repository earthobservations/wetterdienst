...
from wetterdienst.provider.zamg.observation import GeosphereObservationParameter
from wetterdienst.provider.zamg.observation.api import GeosphereObservationUnit
