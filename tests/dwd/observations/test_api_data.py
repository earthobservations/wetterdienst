...
from wetterdienst.dwd.observations.api import DWDObservationValues
...
def test_dwd_observation_data_parameter_set():
    ...
    assert request == DWDObservationValues(
        station_id=[1],
