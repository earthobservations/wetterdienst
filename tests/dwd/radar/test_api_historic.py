...
def test_radar_request_radvor_re_yesterday():
    ...
    month_year = request.start_date.strftime("%m%y")
    header = (
        f"RE{date_time}10000{month_year}BY.......VS 3SW P100004HPR E-03INT  60GP 900x 900VV 000MF 00000008QN 016MS "  # noqa:E501,B950
        f"..<deasb,deboo,dedrs,deeis,deess,defbg,defld,dehnr,demem,deneu,denhb,deoft,depro,deros,detur,deumd>"  # noqa:E501,B950
    )
...
def test_radar_request_radvor_rq_yesterday():
    ...
    header = (
        ...
        f"..<asb,boo,drs,eis,ess,fbg,fld,hnr,mem,neu,nhb,oft,pro,ros,tur,umd>"
    )
