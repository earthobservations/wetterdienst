...
def test_noaa_ghcn_values():
    ...
    df_expected = pd.DataFrame(
        [
            [
                "US1NYKN0003",
                pd.Timestamp("2008-01-01 00:00:00+0000", tz="UTC"),
                pd.Timestamp("2009-12-31 00:00:00+0000", tz="UTC"),
                7.9,
                40.6194,
                -73.9859,
                "BROOKLYN 2.4 SW",
            ...
            [
                "USC00305798",
                pd.Timestamp("1951-01-01 00:00:00+0000", tz="UTC"),
                pd.Timestamp("1953-12-31 00:00:00+0000", tz="UTC"),
                6.1,
                40.6,
                -73.9667,
        ...
        columns=["station_id", "from_date", "to_date", "height", "latitude", "longitude", "name", "state", "distance"],
    )
    ...
    df_expected_values = pd.DataFrame(
        [
            ...
            ["US1NYKN0003", "daily", "snow_depth", pd.Timestamp("2020-01-01 05:00:00+0000", tz="UTC"), np.nan, np.nan],
            [
                "US1NYKN0003",
                "daily",
            ...
            ["USC00305798", "daily", "snow_depth", pd.Timestamp("2020-01-01 05:00:00+0000", tz="UTC"), np.nan, np.nan],
            [
                "USC00305798",
                "daily",
    ...
    assert_frame_equal(pd.concat(values_result).reset_index(drop=True), df_expected_values, check_categorical=False)
