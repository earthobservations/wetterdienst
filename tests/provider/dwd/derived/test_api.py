...
from tests.provider.dwd.observation.test_api_stations import expected_df
from wetterdienst import Settings
from wetterdienst.metadata.period import Period
from wetterdienst.provider.dwd.derived import DwdDerivedRequest, DwdDerivedMetadata
...
def test_dwd_monthly_soil_ztumi_long(default_settings: Settings) -> None:
    ...
    expected_dict = [{'station_id': '00150',
        'resolution': 'monthly',
        'dataset': 'soil',
        'parameter': 'ztumi',
...
def test_dwd_hourly_radiation_surface_irradiance_long(default_settings: Settings) -> None:
    ...
    expected_dict = [{'station_id': '18001',
        'resolution': 'hourly',
