...
def test_history_request_requires_station_or_all() -> None:
    """Test that HistoryRequest requires either 'station' or 'all' parameter."""
    with pytest.raises(ValidationError):
        HistoryRequest.model_validate({"provider": "dwd", "network": "observation", "parameters": "daily/kl"})
