...
- Large refactoring
- Make period type in DWDObservationRequest and cli optional
...
- Rename DWDStationRequest to DWDObservationRequest
...
- extend DWDObservationRequest to take multiple parameters as request
